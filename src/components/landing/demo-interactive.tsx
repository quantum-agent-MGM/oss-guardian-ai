    ...
    <section id="demo" className="px-6 py-24 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-4xl">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="glass-card p-1 flex gap-2 max-w-xl mx-auto"
        >
          <input
            type="text"
        ...
        {result === "done" && (
          <motion.div
            ...
            className="mt-8 glass-card p-6 max-w-2xl mx-auto"
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="rounded-xl border border-amber-500/10 bg-amber-500/5 p-4">
                  <p className="text-sm font-semibold text-amber-400">⚠️ Potential XSS en user input</p>
                  <p className="text-sm text-zinc-400 mt-1">
                    <code className="text-zinc-300 text-xs bg-zinc-800 px-1 rounded">src/components/Form.tsx:42</code> — 
                    Sanitiza con <code className="text-emerald-400 text-xs">DOMPurify</code> antes de renderizar.
                  </p>
                </div>
                <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
                  ...
                  <p className="text-sm text-zinc-400 mt-1">
                    Agrega <code className="text-zinc-300 text-xs bg-zinc-800 px-1 rounded">rate-limiter-flexible</code> para prevenir brute force en login.
                  </p>
                </div>
                <div className="flex items-center gap-2 text-xs text-zinc-600">
                  <span>OSS Guardian AI revisó hace 3 segundos</span>
                  <span>·</span>
                  <span className="text-emerald-500">+12 mejoras sugeridas</span>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        {!result && !loading && (
          <p className="text-center text-xs text-zinc-600 mt-4">
            ↑ Pega cualquier repo público para simular una review
          </p>
        )}
      </div>
    </section>
